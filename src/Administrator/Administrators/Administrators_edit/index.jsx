...
//   };
  ...
  Administrator Details
          ...
          <form >
            <div  >
            { <div className="row headingLabel complyColor">{params.id ?" Edit Administrator" : "Add Administrator"}</div>}
              <div className="row">
                <div className="col-2" >
                  <div
             ...
             Country Code:
                ...
                <div className="col-10">
                    ...
                    <Select align="center" defaultValue={1}type="Mobile"className='selectBox text table_content' >
