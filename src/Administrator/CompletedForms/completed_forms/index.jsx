...
const rows = [
  createData('Group Tax','W-8BEN-E (Oct 2021)','test',	'6000022',	'test@gmail.com','06/13/2023 13:11','Set as not Sent',' View PDF'),
  createData('Group Tax','W-8BEN-E (Oct 2021)','test',	'6000022',	'test@gmail.com','06/13/2023 13:11','Set as not Sent',' View PDF'),
  createData('Group Tax','W-8BEN-E (Oct 2021)','test',	'6000022',	'test@gmail.com','06/13/2023 13:11','Set as not Sent',' View PDF'),
  createData('Group Tax','W-8BEN-E (Oct 2021)','test',	'6000022',	'test@gmail.com','06/13/2023 13:11','Set as not Sent',' View PDF' ),
  createData('Group Tax','W-8BEN-E (Oct 2021)','test',	'6000022',	'test@gmail.com','06/13/2023 13:11','Set as not Sent',' View PDF' ),
  ...
  Completed Forms
   ...
   InputProps={{
                ...
                <TableBody>
                    {rows.map((row) => (
                        ...
                        >
                            ...
                            <TableCell style={{width:"40px"}} className="table_content"align="center">
                                {row.date}
                            </TableCell>
                            <TableCell className="table_content"align="center">
                            ...
                            <TableCell align="center" colSpan={2}>
                                <div className="actionRow"style={{display:"flex", width:"max-content" ,fontSize:'12px'}}>
                                   
                                    <span className="addForms">{row.admin}</span><span className="addForms">{row.pdf}</span> <span className='mt-2'>
                                    
                                 
                                 
                                 
                                 <DeleteIcon  style={{ color: "red" , fontSize:'20px',marginLeft:'7px'}}/>
     ...
     <Pagination count={10} variant="outlined" shape="rounded" color='primary'/>
                ...
                <Button  size="small"className="btn-cstm mx-1 mb-3" style={{float:"right"}}>Export</Button>
