...
import { createContentTranslations, getAllLanguages, getContentTranslation } from "../../../redux/Actions";
...
export default function Language_details() {
  ...
  useEffect(() => {
    ...
    console.log(idPageData?.contentTranslationData?.content,"idPageData?.contentTranslationData?.content")
    // Component mounted, initialize the editor states
    setEditorState1(
      idPageData?.contentTranslationData?.content
        ? () =>  {
          const blocksFromHTML = convertFromHTML(idPageData?.contentTranslationData?.content)
  ...
  useEffect(() => {
    if(params.id){
      dispatch(getContentTranslation(params.id,params.langId,(data)=>{ setData(data)}));
    }
}, [params.id]);
                ...
                <form onSubmit={(e) => handleSubmit(e)}>
                  ...
                  <div>
                    ...
                    <div className="row">
                      ...
                      <div className="col-10"> <Checkbox 
                        name="bulkTranslation"
                          className="checkBox"
                          defaultChecked={idPageData?.contentTranslationData?.bulkTranslation}
                          onChange={handleToogle}/></div>
